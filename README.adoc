...
. Move the file: "build/libs/hivemq-kafka-hello-world-customization-4.45.0.jar" to the directory: "HIVEMQ_HOME/extensions/hivemq-kafka-extension/customizations"
